...
public class CartController {
    ...
    public Cart addProductToCart(@PathVariable int cartId, @RequestBody Product product) {
    ...
    public Cart removeProductFromCart(@PathVariable int cartId, @RequestBody Product product) {
    ...
    public Cart updateProductQuantity(@PathVariable int cartId, @RequestBody Product product,int quantity) {
